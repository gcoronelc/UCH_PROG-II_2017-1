            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?php echo $pagina == 'menu_usuario' ? 'active' : ''; ?>
                                    <?php echo $pagina == 'menu_docente' ? 'active' : ''; ?>
                                    <?php echo $pagina == 'menu_curso' ? 'active' : ''; ?> treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="<?php echo $pagina == 'menu_docente' ? 'active' : ''; ?>"><a href="?p=menu_docente"><i class="fa ion-ios-people"></i> Docente</a></li>
                                <li class="<?php echo $pagina == 'menu_curso' ? 'active' : ''; ?>"><a href="?p=menu_curso"><i class="fa ion-ios-compose"></i> Curso</a></li>
                            </ul>
                        </li>
                        <li class="<?php echo $pagina == 'menu_aescolar' ? 'active' : ''; ?> treeview">
                            <a href="#">
                                <i class="fa ion-ios-bookmarks"></i> <span>Planificación Escolar</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="<?php echo $pagina == 'menu_aescolar' ? 'active' : ''; ?>"><a href="?p=menu_aescolar"><i class="fa ion-university"></i> Año escolar</a></li>
                            </ul>
                        </li>
                        <li class="<?php echo $pagina == 'menu_matricula' ? 'active' : ''; ?>
                                    <?php echo $pagina == 'menu_mensualidad' ? 'active' : ''; ?> treeview">
                            <a href="#">
                                <i class="fa ion-person-add"></i> <span>Matricula</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="<?php echo $pagina == 'menu_matricula' ? 'active' : ''; ?>"><a href="?p=menu_matricula"><i class="fa ion-person-add"></i> Matricula</a></li>
                                <li class="<?php echo $pagina == 'menu_mensualidad' ? 'active' : ''; ?>"><a href="?p=menu_mensualidad"><i class="fa ion-cash"></i> Mensualidades</a></li>
                            </ul>
                        </li>
                        <li class="<?php echo $pagina == 'menu_reportegerencial' ? 'active' : ''; ?>
                                    <?php echo $pagina == 'menu_seguimientoycontrol' ? 'active' : ''; ?> treeview">
                            <a href="#">
                                <i class="fa ion-ios-pie"></i> <span>Reportes</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="<?php echo $pagina == 'menu_reportegerencial' ? 'active' : ''; ?>"><a href="?p=menu_reportegerencial"><i class="fa ion-person"></i> Reporte Gerencial</a></li>
                                <li class="<?php echo $pagina == 'menu_seguimientoycontrol' ? 'active' : ''; ?>"><a href="?p=menu_seguimientoycontrol"><i class="fa ion-ios-people"></i> Control</a></li></ul>
                        </li>
                    </ul>
                </section>
