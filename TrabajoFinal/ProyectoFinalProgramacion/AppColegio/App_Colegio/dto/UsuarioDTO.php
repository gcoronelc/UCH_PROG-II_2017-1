...
class UsuarioDTO {
    ...
    function __construct($col_TipoUsuario_id_tipousuario, $nombre_usuario, $ap_usuario, $am_usuario, $sexo_usuario, $email_usuario, $usu_usuario, $password_usuario, $fregistro_usuario, $estado_usuario) {
