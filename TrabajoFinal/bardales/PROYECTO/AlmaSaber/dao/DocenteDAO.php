        ...
        try {
            ...
            if ($doc == null) {
                if ($dni == null) {
                    ...
                    $statement->bindParam(":codigo_docente", $docente->getCodigo_docente());
                    $statement->bindParam(":dni_docente", $docente->getDni_docente());
                    $statement->bindParam(":nombre_docente", $docente->getNombre_docente());
                    $statement->bindParam(":ap_docente", $docente->getAp_docente());
                    $statement->bindParam(":am_docente", $docente->getAm_docente());
                    $statement->bindParam(":sexo_docente", $docente->getSexo_docente());
                    $statement->bindParam(":email_docente", $docente->getEmail_docente());
                    $statement->bindParam(":telefono_docente", $docente->getTelefono_docente());
                    $statement->bindParam(":celular_docente", $docente->getCelular_docente());
                    $statement->bindParam(":fregistro_docente", $docente->getFregistro_docente());
                    $statement->bindParam(":estado_docente", $docente->getEstado_docente());
