...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" class="'+classes.sFilterInput+'" placeholder="Buscar usuario..."/>';
	...
	function _fnInitialise ( settings )
	{
		...
		// Ajax source - this allows the table to 
                // 
                // look initialised for Ajax sourcing
