...
<div class="modal fade" id="dataEliminarGRA" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <form id="formulario_eliminar_gra">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <input type="hidden" id="txtCodigoGrado" name="txtCodigoGrado">
