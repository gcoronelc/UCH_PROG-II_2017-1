                        ...
                        <div class="col-md-6">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtTelefonoAlumnomat" name="txtTelefonoAlumno" placeholder="Telefono del Alumno" REQUIRED>
                                </div>

                                <div class="form-group">
                                    <label for="txtCelularAlumno">Celular</label>
                                    <input type="text" class="form-control" id="txtCelularAlumnomat" name="txtCelularAlumno" placeholder="Celular del Alumno" REQUIRED>
                                </div>
                                </div>
