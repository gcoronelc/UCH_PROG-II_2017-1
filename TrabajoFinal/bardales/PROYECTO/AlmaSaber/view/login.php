...
<html>
    ...
    <body class="hold-transition login-page">
        ...
        <video  autoplay loop muted>
            <source src="video/intro.3gp" type='video/3gp'/>
        ...
        <div class="login-box">
            <div class="login-logo">
                <a href="#"><b style="color: #3c8dbc;">Bienvenido </b>al Sistema</a>
            </div><!-- /.login-logo -->
            <div class="login-box-body">
                <p class="login-box-msg"><img src="images/logo.png" width="150px"></p>
                ...
                <a href="#" class="text-center">¿Necesitas Ayuda?</a><br>
                <a href="pages/modal/usuario/create.php" class="text-center">Regístrate</a>
